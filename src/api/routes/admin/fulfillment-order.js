export default async (req, res) => {
  ...
  console.warn(
    "medusa-fulfillment-shippo: endpoint /admin/fulfillments/:id/shippo/order is deprecated since v0.17.0"
  )
  console.warn(
    "medusa-fulfillment-shippo: endpoint /admin/fulfillments/:id/shippo/order will be removed v0.20.0"
  )
